            ...
            <div class="card h-100">
                ...
                <div class="card-body p-3"> <!-- Reduced padding -->
                    ...
                    <ul class="card-text">
                        ...
                        <li>Penyelesaian Sistem Persamaan Linear Dua Variabel</li>
                    </ul>
        ...
        <div class="col-lg-3 col-md-4 mb-4"> <!-- Smaller columns -->
            <div class="card h-100">
                ...
                <div class="card-body p-3"> <!-- Reduced padding -->
                    ...
                    <p class="card-text">Untuk lebih memahami materi </p>
                    <a href="media.html" class="btn btn-primary">Lihat</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-4 mb-4"> <!-- Smaller columns -->
            <div class="card h-100">
                ...
                <div class="card-body p-3"> <!-- Reduced padding -->
                    ...
                    <a href="kuis.html" class="btn btn-primary">Mulai Latihan</a>
                </div>
            </div>
        </div>
    </div>
